package com.patel.newzyhunt.roomdb
...
import com.patel.newzyhunt.retrofit.NewsApi
import com.patel.newzyhunt.retrofit.NewsDataFromJson
import com.patel.newzyhunt.retrofit.RetrofitHelper
...
class NewsRepository {
    ...
    fun getNewsApiCall(category: String?): MutableLiveData<List<NewsModel>> {
        ...
        val call = RetrofitHelper.getInstance().create(NewsApi::class.java)
            .getNews("in", category, MainActivity.API_KEY)
